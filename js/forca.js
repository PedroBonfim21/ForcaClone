...
function comparalistas(letra){
    ...
    if(vitoria == true)
    {
        abreModal("PARABÉNS!", "Você venceu...", "aqui");
        tentativas = 0;
        piscarBotaoJogarNovamente(true);
    }
}
...
function abreModal(titulo, mensagem, link){
    let modalTitulo = document.getElementById("exampleModalLabel");
    modalTitulo.innerText = titulo;

    let modalBodyParagraph = document.getElementById("modalBodyParagraph1");
    modalBodyParagraph.innerHTML = mensagem;

    let textoVencedor = document.getElementById("textoVencedor")
    textoVencedor.innerText = 'Resgate sua recompensa clicando '
    
    let modalBodyLink = document.getElementById('modalBodyLink')
    modalBodyLink.innerHTML= link
